...
nodeTest("workspace runtime contracts", async () => {
  ...
  assert.equal(JSON.stringify(rememberedSources.files), JSON.stringify([{ imageId: "one", sourceId: "source-a", clientKey: null, relativePath: "a.png", handle: { kind: "file", name: "a.png" }, parentHandle: null }, { imageId: "two", sourceId: "source-b", clientKey: null, relativePath: "b.png", handle: { kind: "file", name: "b.png" }, parentHandle: null }]), "browser file handles retain their durable image, source, and direct-parent IDs");
